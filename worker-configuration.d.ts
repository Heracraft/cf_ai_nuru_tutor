/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c608f80209edd5e33cffd66e8b49285b)
// Runtime types generated with workerd@1.20260120.0 2026-01-19 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.open-next/worker");
	}
	interface WorkflowsEnv {
		nuru_tutor_db: D1Database;
		AI: Ai;
		GOOGLE_GENERATIVE_AI_API_KEY: string;
		LESSON_PLAN_WORKFLOW: Workflow /* LessonPlanWorkflow */;
	}
	interface Env {
		GOOGLE_GENERATIVE_AI_API_KEY: string;
		nuru_tutor_db: D1Database;
		...
		LESSON_PLAN_WORKFLOW?: Workflow /* LessonPlanWorkflow */;
		ASSETS?: Fetcher;
		WORKFLOWS_SERVICE?: Fetcher /* nuru-tutor-workflows */;
	}
}
